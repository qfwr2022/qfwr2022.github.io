...
image: /slides/lec-05/imgs/dplyr-rows-cols.png
# editor: visual
---
...
📖 阅读 [*R for Data Science*](https://r4ds.had.co.nz/) 一书**第5章**、第13章和第18章，这些章节依次介绍如何利用 dplyr 包中的核心函数对单表数据和关系型数据表进行处理以及管道操作符 `%>%` 的相关知识。
...
⌨️ [见课堂讲义——并非动手编程练习，思维体操而已](/slides/lec-05/L05_Transformation.html#10)
